...
description: "Reference documentation for External endpoint."
---
...
Notes:
- If `emails` length is less than 10, the endpoint performs real-time verification and returns an array of results.
...
### Response (multiple emails, less than 10)
Status: `200 OK`
